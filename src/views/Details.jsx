            ...
            <div className="details-card">
              ...
              <div className="details_info">
                ...
                <div>
                  ...
                  <address>
                    <p>
                      {EventDetails.address_name}-{EventDetails.contact_name}
                    </p>
                    <p>
                ...
                <div>
                  <h3>Plus d'info</h3>
                  <p>
                    <ImPhone /> : {EventDetails.access_phone}
                  </p>
                  <p>
                    <HiMail /> :{" "}
                    <a href="mailto:{EventDetails.access_mail}">
                      {EventDetails.access_mail}
                    </a>
                  </p>
                  <p>
                    <CgWebsite /> :
                    <a target="_blank" href={EventDetails.contact_url}>
